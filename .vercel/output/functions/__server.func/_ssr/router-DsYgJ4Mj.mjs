...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DsYgJ4Mj.js
var router_DsYgJ4Mj_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-D54L2IkU.css";
var APP_NAME = "TERNION";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "TERNION is a trinary sovereign synthesis console. Hold thesis, antithesis, and the third state."
			},
			{
				name: "theme-color",
				content: "#0c0c0b"
...
var $$splitComponentImporter = () => import("./routes-BHnVn9rS.mjs");
...
//#endregion
export { getRouter, router_DsYgJ4Mj_exports as t };
