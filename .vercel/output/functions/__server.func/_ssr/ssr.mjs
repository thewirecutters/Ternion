...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DXVzoDYH.mjs");
...
var manifest = {
	"6ec46aa1695a35bea983af065ffe69bf4def7c9b894e1662e52ef9b634743947": {
		functionName: "aiStatus_createServerFn_handler",
		importer: () => import("./api-B-nkfZao.mjs")
	},
	"bf48a6eb9b82c03b34b6e4489a977cbecfd816bc56aeca0d0d373f2fe50e41ea": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DsYgJ4Mj.mjs").then((n) => n.t),
